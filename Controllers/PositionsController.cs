...
namespace CentricProject.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "positionID,position")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "positionID,position")] Position position)
        {
            if (ModelState.IsValid)
            {
